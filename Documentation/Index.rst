...
.. todo::
   ...
   - if Sitemap/Index exists, mache Link "Sitemap"
   - option todo_include_todos
   - editor
   - style admonition todo
   - easy_install PIL
   - create a script that does a setup diagnostic
   - I've dropped the screenshot-fullsize
